...
df_chain <- 
    read_csv(
        "data_output/spy_weekly_2014_2018_chain_desc.csv"
        , col_types = cols()
    )

df_chain_hist <- 
    read_csv(
        "data_output/spy_weekly_2014_2018_chain_hist.csv"
        , col_types = cols()
    )

df_opt_hist <-
    read_csv(
        "data_output/spy_weekly_2014_2018_opt_hist.csv"
        , col_types = cols()
    )
...
##########################
write_csv(df_pnl, "spy_weekly_2014_2018_pnl_master.csv")
write_csv(df_trade, "spy_weekly_2014_2018_trade_master.csv")
